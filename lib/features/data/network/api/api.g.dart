...
class _IAppServiceApiClient implements IAppServiceApiClient {
  ...
  Future<ChangePasswordCodeResponse> changePassword(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(resetPasswordCodeRequest.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ChangePasswordCodeResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ChangePasswordCodeResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<ConfirmEmailResponse> confirmEmail(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(confirmEmailRequest.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ConfirmEmailResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/api/v1/auth/user/email/confirm',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = ConfirmEmailResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<SendDeviceTokenResponse> sendDeviceToken(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(deviceTokenRequest.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SendDeviceTokenResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = SendDeviceTokenResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<RefreshTokenResponse> refreshToken(RefershTokenRequest refershTokenRequest) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(refershTokenRequest.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
  ...
  Future<NotificationsDataResponses> getNotifications(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(paginationRequest.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NotificationsDataResponses>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = NotificationsDataResponses.fromJson(_result.data!);
    return value;
  }
  ...
  Future<ReadingNotificationResponse> readingNotification(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(requestWithId.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ReadingNotificationResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ReadingNotificationResponse.fromJson(_result.data!);
    return value;
  }
